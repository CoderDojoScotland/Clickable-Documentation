...
public class eHoodieDocs extends PApplet {
...
class Btn {
  ...
  int h=0;
  int c;
  int sk = color(255, 255, 255);
  public Btn(int x, int y, int w, int h, String lbl, String toCopy, int c) {
    this.x=x;
    this.y=y;
    this.h=h;
    this.w=w;
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "eHoodieDocs" };
    if (passedArgs != null) {
